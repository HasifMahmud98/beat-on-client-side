...
const Footer = () => {
    return (
        <div className="mt-5 bg-white" aria-labelledby="footer-heading">
        ...
        ">
                ...
                <div className="mt-8 md:mt-0 md:order-1">
                    <span className="mt-2 text-sm font-light text-gray-500"> Copyright © 2021 - 2022 <a href="#" className="mx-2 text-wickedblue hover:text-gray-300" rel="noopener noreferrer">@BeatOn</a>. Since 2021 </span>
                </div>
            </div>
        </div>
    );
